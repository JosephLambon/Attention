...
def visualize_attentions(tokens, attentions):
    ...
    """
    for i in range(12): # Loop through each attention layer
        for k in range(12): # Loop through each attention head in layer i
            generate_diagram( # Generate diagram for layer i, head js
                i+1,
                k+1,
                tokens,
                attentions[i][0][k]
